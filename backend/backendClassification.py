...
system_prompt = (
    ...
    "Classify the text as a higher security level to avoid any potential risks if unsure."
    "The explicit content of the file should take precedent on its classification rather than the context." 
