<script>
    ...
    // because i have to re-render them in and therefore i have to suppress it from scrolling to bottom
    ...
    <div class="h-[10h] mt-auto">
        ...
        >
            <input
                ...
                autofocus
                name="message"
                class="w-full h-10 rounded-lg bg-slate-100 text-slate-700 px-3"
                placeholder="Ask something here..."
            />
            <button
                disabled={waitingformessage}
                type="submit"
                class="absolute end-2 text-xl text-slate-800 hover:text-orange-300"
            >
                ▶
            </button>
        </form>
